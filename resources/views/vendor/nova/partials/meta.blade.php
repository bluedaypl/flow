...
if (window.mobileCheck()) {
    document.addEventListener('keydown', function(event) {
        if (event.key === 'Enter') {
            document.location.href = '/order/scanner?shipment_number=' + scannedCode;
            scannedCode = ''; // Reset kodu po skanowaniu
        } else {
            scannedCode += event.key;
        }
    
        // Resetowanie skanowania, jeśli za długo nie ma nowych znaków
        timeout = setTimeout(() => {
            scannedCode = '';
